          ...
          <div className="reveiw-area">
            ...
            <span className="text-area">
              <p>
                ...
                corporis, modi velit voluptatum laboriosam id nostrum
                perferendis quis sapiente dignissimos sint error temporibus
                quibusdam necessitatibus voluptates, rerum labore possimus
                ratione!
              </p>
            </span>
          </div>
